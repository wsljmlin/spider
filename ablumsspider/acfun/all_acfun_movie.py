...
class all_acfun_movie():
    def __init__(self):
        self.base=["http://www.acfun.tv/v/list96/index.htm#page=1"
                    ,"http://www.acfun.tv/v/list96/index.htm#page=1"
                    ,"http://www.acfun.tv/v/list96/index.htm#page=2"
                    ,"http://www.acfun.tv/v/list96/index.htm#page=3"
                    ,"http://www.acfun.tv/v/list96/index.htm#page=4"
                    ,"http://www.acfun.tv/v/list96/index.htm#page=5"
                   ]
        self.seedList = []
        ...
        self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "all_acfun_movie_" + self.today + ".txt")
    ...
    def doProcess(self):
        for seed in self.base:
            ...
            seed_p = "http://www.acfun.tv/list/getlist?channelId=96&sort=0&pageSize=20&pageNo=%s" % pageNo
            ...
            for each in data:
                if each.get('link') is not None:
                    sub_seed = "http://www.acfun.tv%s" % each['link']
