...
echo "python ./all_iqiyi_vipmovie.py >> $logfile" >> $logfile
python ./all_iqiyi_vipmovie.py >> $logfile

echo `date +[%Y/%m/%d-%H:%M:%S]` >> $logfile
echo "python ./all_iqiyi_viptv.py >> $logfile" >> $logfile
python ./all_iqiyi_viptv.py >> $logfile
