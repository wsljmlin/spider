...
class all_le_viptv():
    def __init__(self):
        ...
        self.seedBase = ["http://api.vip.le.com/search/interface?from=pc_03&sales_area=cn&user_setting_country=cn&cg=2&ph=420001&pt=141001&dt=1&src=1&ispay=1&stype=1&lang=zh_cn&stt=1&ps=60&pn=1&lh=0&vt=180001&sc=&ar=&yr=&or=7&eid=4849751270334810859"
                         , "http://api.vip.le.com/search/interface?from=pc_03&sales_area=cn&user_setting_country=cn&cg=2&ph=420001&pt=141001&dt=1&src=1&ispay=1&stype=1&lang=zh_cn&stt=1&ps=60&pn=1&lh=0&vt=180001&sc=&ar=&yr=&or=7&eid=4849751270334810859"
                         ]
        self.seedList = []
        self.images = {}
        ...
        self.seqNocnt = 1
        self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "all_le_viptv_" + self.today + ".txt")
    ...
    def firstSpider(self, seed):
        ...
        if json_data.has_key("starring"):
            ...
            elif type(star_P) is types.ListType:
                star = ','.join(star_P)
