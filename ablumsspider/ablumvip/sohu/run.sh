...
echo "python ./all_sohu_vipmovie.py >> $logfile" >> $logfile
python ./all_sohu_vipmovie.py >> $logfile

echo `date +[%Y/%m/%d-%H:%M:%S]` >> $logfile
echo "python ./all_sohu_viptv.py >> $logfile" >> $logfile
python ./all_sohu_viptv.py >> $logfile
