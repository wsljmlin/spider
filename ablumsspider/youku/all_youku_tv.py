...
class all_youku_tv():
    def __init__(self):
        print "Do spider all_youku_tv."
        self.program = copy.deepcopy(BASE_CONTENT["program"])
        self.program_sub = PROGRAM_SUB
        self.seedBase = [ "http://list.youku.com/category/show/c_97_s_6_d_1_p_1.html",
                          "http://list.youku.com/category/show/c_97_s_6_d_1_p_1.html",
                          "http://list.youku.com/category/show/c_97_s_6_d_1_p_2.html",
                          "http://list.youku.com/category/show/c_97_s_6_d_1_p_3.html",
                          "http://list.youku.com/category/show/c_97_s_6_d_1_p_4.html",
                          "http://list.youku.com/category/show/c_97_s_6_d_1_p_5.html",
                          "http://list.youku.com/category/show/c_97_s_6_d_1_p_6.html"
                       ]
        self.seedList = []
        self.dataDir = '.' + os.path.sep + 'data'
        self.today = time.strftime('%Y%m%d', time.localtime())
        self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "all_youku_tv2_" + self.today + ".txt")
