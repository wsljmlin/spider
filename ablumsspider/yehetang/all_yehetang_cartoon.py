...
class all_yehetang_cartoon():
    def __init__(self):
        print "Do spider all_yehetang_cartoon."
        self.program = copy.deepcopy(BASE_CONTENT["program"])
        self.program_sub = PROGRAM_SUB
        self.seedBase = ["http://www.yehetang.com/pd/4-1.html"
                         , "http://www.yehetang.com/pd/4-1.html"
                         , "http://www.yehetang.com/pd/4-2.html"
                         , "http://www.yehetang.com/pd/4-3.html"
                         , "http://www.yehetang.com/pd/4-4.html"
                         , "http://www.yehetang.com/pd/4-5.html"
                         , "http://www.yehetang.com/pd/4-6.html"
        ]
        self.seedList = []
        self.dataDir = '.' + os.path.sep + 'data'
        self.today = time.strftime('%Y%m%d', time.localtime())
        self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "all_yehetang_cartoon_" + self.today + ".txt")
    ...
    def secondSpider(self, video_list):
        ...
        for video in video_list:
            ...
            if len(video_list) <= 4 and setNumber == "":
                setNumber = "1"
