...
class ablum_bilibili_game():
    def __init__(self):
        self.base=[
                {"http://www.bilibili.com/video/game-video-1.html#!page=1":"17"} #单机联机
                ,{"http://www.bilibili.com/video/game-video-1.html#!page=1":"17"} #单机联机
                ,{"http://www.bilibili.com/video/game-ctary-network-1.html#!page=1":"65"} #网游-电竞
                ,{"http://www.bilibili.com/video/music-game-1.html#!page=1":"136"} #音游
                ,{"http://www.bilibili.com/video/game-mugen-1.html#!page=1":"19"} #Mugen
                ,{"http://www.bilibili.com/video/gmv-1.html#!page=1":"121"} #GMV
            ]
        self.seedList = []
        ...
        self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "ablum_bilibili_game_" + self.today + ".txt")
