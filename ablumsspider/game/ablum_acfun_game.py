...
class ablum_acfun_game():
    def __init__(self):
        self.base=["http://www.acfun.tv/v/list84/index.htm#page=1" #主机单机
        ...
        self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "ablum_acfun_game_" + self.today + ".txt")
