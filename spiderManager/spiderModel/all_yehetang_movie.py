...
class all_yehetang_movie():
    def __init__(self):
        print "Do spider all_yehetang_movie."
        self.program = copy.deepcopy(BASE_CONTENT["program"])
        self.program_sub = PROGRAM_SUB
        self.seedBase = ["http://www.yehetang.com/pd/1-1.html"
                         , "http://www.yehetang.com/pd/1-1.html"
                         , "http://www.yehetang.com/pd/1-2.html"
                         , "http://www.yehetang.com/pd/1-3.html"
                         , "http://www.yehetang.com/pd/1-4.html"
                         , "http://www.yehetang.com/pd/1-5.html"
                         , "http://www.yehetang.com/pd/1-6.html"
                         , "http://www.yehetang.com/pd/1-7.html"
        ]
        self.seedList = []
        ...
        self.ctype = {}
        self.jsonData = ""
    #     self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "all_yehetang_movie_" + self.today + ".txt")
    #
    # def __del__(self):
    ...
    def secondSpider(self, video_list):
        for video in video_list:
            ...
            if len(self.program['poster']) > 0:
                poster = self.program['poster'][0]['url']
