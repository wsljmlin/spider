...
class all_bilibili_cartoon():
    def __init__(self):
        self.base=["http://bangumi.bilibili.com/anime/index#p=1&v=0&area=&stat=0&y=0&q=0&tag=&t=0&sort=0"
                   ,"http://bangumi.bilibili.com/anime/index#p=1&v=0&area=&stat=0&y=0&q=0&tag=&t=0&sort=0"
                   ,"http://bangumi.bilibili.com/anime/index#p=2&v=0&area=&stat=0&y=0&q=0&tag=&t=0&sort=0"
                   ,"http://bangumi.bilibili.com/anime/index#p=3&v=0&area=&stat=0&y=0&q=0&tag=&t=0&sort=0"
                   ,"http://bangumi.bilibili.com/anime/index#p=4&v=0&area=&stat=0&y=0&q=0&tag=&t=0&sort=0"
                   ,"http://bangumi.bilibili.com/anime/index#p=5&v=0&area=&stat=0&y=0&q=0&tag=&t=0&sort=0"
            ]
        self.seedList = []
        ...
        self.jsonData = ""
    #     self.dataFile = spiderTool.openFile(self.dataDir + os.path.sep + "all_bilibili_cartoon_" + self.today + ".txt")
    #
    # def __del__(self):
    ...
    def doProcess(self):
        for seed in self.base:
            ...
            seed_p = "http://bangumi.bilibili.com/web_api/season/index?page=%s&page_size=20&version=0&is_finish=0&start_year=0&quarter=0&tag_id=&index_type=0&index_sort=0" % pageNo
